...
def get_cases(long_descriptions=False):
    ...
    cases.append(TransformFunction("HtmlEvasion-html-003", None, evasions.html.move_body_to_nested_div.parameterize(N=1040))) # vertical
    ...
    cases.append(TransformFunction("HtmlEvasion-html-517", None, cases[-1], evasions.html.move_body_to_nested_div.parameterize(N=1040)))
